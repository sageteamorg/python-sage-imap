...
.. important::
   ...
   This example emphasizes UID-based searches for production reliability!
...
.. code-block:: python
   ...
   class UIDSearchExample:
       ...
       def demonstrate_uid_search_operations(self):
           ...
           try:
               with IMAPClient(config=self.config) as client:
                   ...
                   logger.info(f"UID search operations completed successfully")
       ...
       def demonstrate_search_pagination(self, uid_service: IMAPMailboxUIDService):
           ...
           try:
               ...
               if all_messages.is_empty():
                   logger.info(f"No messages found for pagination demo")
                   return
       ...
       def demonstrate_advanced_search_patterns(self, uid_service: IMAPMailboxUIDService):
           ...
           try:
               ...
               logger.info(f"Conversation thread detection would require header analysis")
   ...
   def main():
       ...
       try:
           ...
           logger.info(f"UID search operations example completed successfully!")
